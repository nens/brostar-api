...
def import_bro_data_task(import_task_instance_uuid: str) -> None:
    ...
    import_task_instance = api_models.ImportTask.objects.get(uuid=import_task_instance_uuid)
...
def upload_bro_data_task(
    ...
    # Lookup and update the import task instance
    upload_task_instance = api_models.UploadTask.objects.get(uuid=upload_task_instance_uuid)
