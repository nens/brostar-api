...
class GAR(models.Model):
    ...
    primary_colour = models.CharField(max_length=100, null=True)
    secondary_colour = models.CharField(max_length=100, null=True)
    colour_strength = models.CharField(max_length=100, null=True)
